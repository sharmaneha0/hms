...
//
        ...
        pdfService.generateBookingPDF("C:\\hms_Bookings\\confirmation-order"+savedBooking.getId()+".pdf", property);
        twilioService.sendSms("+919155766452","","Booking confirm. Your booking id is: "+booking.getId());
